class Livre:
    ...
    def afficher_détails_livre(self):
        print(f"titre : {self.__titre}, auteur : {self.__auteur}, nombre_de_pages : {self.__nombre_de_pages}") 


livre1 = Livre("1984", "George Orwell", 328)
livre1.afficher_détails_livre()

livre1.set_nombre_de_pages(-50)  #for error
livre1.set_nombre_de_pages(400)
livre1.afficher_détails_livre()
